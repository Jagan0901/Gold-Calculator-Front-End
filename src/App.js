...
function App() {
  ...
  const getGoldPrice = ()=>{
    fetch(`https://metals-api.com/api/latest?access_key=${API_KEY}&base=INR&symbols=XAU`, {method:"GET"})
  ...
  // console.log(goldData.rates['XAU']);
  
  // const goldDate = goldData.date;
  // const goldPrice = goldData.rates;
